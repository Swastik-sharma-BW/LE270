...
#ifdef FIBOCOM_BASE
    UINT16              preFibocomRefCmdNum;
    const AtCmdPreDefInfoC    *pFibocomDefRefCmdList;
#if defined(FIBOCOM_OPENCPU)
    UINT16              preFibocomCustCmdNum;
    const AtCmdPreDefInfoC    *pFibocomDefCustCmdList;
#endif    
#endif
...
#ifdef FIBOCOM_BASE
    int ffw_chanState; /// 0 cmd 1 bypass 2 odm
    bool first_infor_text;
    int32_t (*bypass_data_cb)(void *param, const void *data, int32_t size);
    void *param;
#endif
