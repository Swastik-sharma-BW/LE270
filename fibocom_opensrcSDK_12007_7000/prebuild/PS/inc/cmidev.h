...
typedef enum CmiDevGetBasicCellInfoMode_Enum
{
    ...
    CMI_DEV_GET_BASIC_CELL_ID_HIGH_PRO_PLMN,        /* same as CMI_DEV_GET_BASIC_CELL_ID, with higher priority than PLMN search */
    CMI_DEV_GET_BASIC_CELL_ID_HIGH_PRO_WIFI,        /* same as CMI_DEV_GET_BASIC_CELL_ID, with higher priority than WIFI scan */
    CMI_DEV_GET_BASIC_CELL_ID_HIGH_PRO_PLMN_WIFI,   /* same as CMI_DEV_GET_BASIC_CELL_ID, with higher priority than PLMN search and WIFI scan */
