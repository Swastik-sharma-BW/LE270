...
typedef enum _EPAT_CMI_MM_PRIM_ID_TAG
{
    ...
    CMI_MM_SET_SOFTRST_AUTHREJ_REQ,                 //CmiMmSetSoftRstAuthRejReq
    CMI_MM_SET_SOFTRST_AUTHREJ_CNF,                 //CmiMmSetSoftRstAuthRejCnf
    CMI_MM_GET_SOFTRST_AUTHREJ_REQ,                 //CmiMmGetSoftRstAuthRejReq
    CMI_MM_GET_SOFTRST_AUTHREJ_CNF,                 //CmiMmGetSoftRstAuthRejCnf
...
/******************************************************************************
 * CMI_MM_SET_SOFTRST_AUTHREJ_REQ
******************************************************************************/
typedef struct CmiMmSetSoftRstAuthRejReq_Tag
{
    BOOL    bEnable;
    UINT8   rsvd;
    UINT8   rstTimesStp1;       // soft reset times for step1
    UINT8   rstTimesStp2;       // soft reset times for step2

    UINT16  delayMinSec;        // delay random Min second before soft reset
    UINT16  delayMaxSec;        // delay random Max second before soft reset
    UINT16  minSecBeforeStp2;   // delay random Min second for the first soft reset of step2
    UINT16  maxSecBeforeStp2;   // delay random Max second for the first soft reset of step2
}CmiMmSetSoftRstAuthRejReq;

/******************************************************************************
 * CMI_MM_SET_SOFTRST_AUTHREJ_CNF
******************************************************************************/
typedef CamCmiEmptySig CmiMmSetSoftRstAuthRejCnf;

/******************************************************************************
 * CMI_MM_GET_SOFTRST_AUTHREJ_REQ
******************************************************************************/
typedef CamCmiEmptySig CmiMmGetSoftRstAuthRejReq;

/******************************************************************************
 * CMI_MM_GET_SOFTRST_AUTHREJ_CNF
******************************************************************************/
typedef struct CmiMmGetSoftRstAuthRejCnf_Tag
{
    BOOL    bEnable;
    UINT8   rsvd;
    UINT8   rstTimesStp1;
    ...
    UINT16  delayMinSec;
    UINT16  delayMaxSec;
    UINT16  minSecBeforeStp2;
    UINT16  maxSecBeforeStp2;
}CmiMmGetSoftRstAuthRejCnf;
