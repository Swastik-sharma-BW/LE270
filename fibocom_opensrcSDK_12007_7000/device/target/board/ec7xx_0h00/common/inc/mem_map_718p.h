...
#if defined(CONFIG_FFW_TWO_BOOTLOADER)  // add for FIBOCOM_BASE
#define BOOTLOADEREXT_FLASH_LOAD_ADDR              (0x0087e000)
#define BOOTLOADEREXT_FLASH_LOAD_SIZE              (0xe000)//56kB, real region size, tool will check when zip TODO:ZIP
#define BOOTLOADEREXT_FLASH_LOAD_UNZIP_SIZE        (0xe000)//56KB ,for ld
#endif
...
// ps ram
//2024-09-02, wangzhen, MTC0832-453. EC718E no PSRAM.
#ifdef CONFIG_FFW_NOT_SUPPORT_PSRAM
...
#else
#ifdef CONFIG_FIBO_FEATURE_ISMS_ENABLE
#define min_heap_size_threshold 0x54000//ims heap(260KB) will also use heap
#else
