...
#define RESERVED_FLASH_FS_REGION_ADDR   (0xfad000)
#define RESERVED_FLASH_FS_REGION_SIZE   (0x6000)
...
#define AP_FLASH_LOAD_SIZE              (0x60f000)
#define AP_FLASH_LOAD_UNZIP_SIZE        (0x61c000) //add less 56KB
#else
#define AP_FLASH_LOAD_ADDR              (0x008cd000)
...
#define FLASH_MEM_BACKUP_NONXIP_ADDR    (0x7b3000)
#define FLASH_MEM_BACKUP_SIZE           (0x18000)
#define FLASH_MEM_BLOCK_SIZE            (0x6000)
#define FLASH_MEM_BLOCK_CNT             (0x4)

//fs addr and size
#define FLASH_FS_REGION_START           (0x6dc000)
#define FLASH_FS_REGION_SIZE            (FLASH_FS_REGION_END-FLASH_FS_REGION_START)
#if defined (FEATURE_FOTA_FS_ENABLE)
#define FLASH_FS_REGION_END             (0x7ad000) //modify end addr

//fota addr and size
#define FLASH_FOTA_REGION_START         (0x7cb000)
#define FLASH_FOTA_REGION_LEN           (0x19000)
#else
#define FLASH_FS_REGION_END             (0x7ad000) //modify end addr
...
#define PSRAM_AREA_P2_OFFSET            (0x00140000)
#else
//2025-02-28, mahongmei, NA, Begin. modify for ap use too much ram compile error.
#define PSRAM_AREA_P2_OFFSET            (0x000ee800)
//2025-02-28, mahongmei, NA, END.
#endif
