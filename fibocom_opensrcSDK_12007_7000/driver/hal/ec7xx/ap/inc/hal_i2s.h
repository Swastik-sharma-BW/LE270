...
typedef enum
{
    ...
    SAMPLERATE_11_025K      = 1,        ///< Sample rate 11.025k
    SAMPLERATE_16K          = 2,        ///< Sample rate 16k
    SAMPLERATE_22_05K       = 3,        ///< Sample rate 22.05k
    SAMPLERATE_24K          = 4,        ///< Sample rate 24k
    SAMPLERATE_32K          = 5,        ///< Sample rate 32k
    SAMPLERATE_44_1K        = 6,        ///< Sample rate 44.1k
    SAMPLERATE_48K          = 7,        ///< Sample rate 48k
    SAMPLERATE_96K          = 8,        ///< Sample rate 96k
}I2sSampleRate_e;
...
typedef void (*i2sErrFunc_fn)(void);// I2s error callback
void hall2sRegisterErrcb(i2sErrFunc_fn cb);
#ifdef CONFIG_FFW_FEATURE_MP3_DECODER_IN_RAM
PLAT_FM_RAMCODE void I2sSrcAdjustVolumnByDb(int16_t *srcBuf, uint32_t srcTotalNum, int8_t dbval);
#else
void I2sSrcAdjustVolumnByDb(int16_t *srcBuf, uint32_t srcTotalNum, int8_t dbval);
#endif
#ifdef FIBOCOM_BASE
void I2sSrcAdjustVolumnByDb2(int16_t *srcBuf, uint32_t srcTotalNum, int8_t dbVal);
void i2s_restore_volume_gain();
#endif
