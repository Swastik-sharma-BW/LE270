...
/*
 * \brief       Register the dumped info of PHY/PS/CUST
 *             and the dumped info is stored with a partition.
 * \param[in]   eExcepInfoType : should be set like EC_EXCEP_INFO_TYPE_(
...
// add by FIBOCOM_BASE BEGIN
#ifdef EC_ASSERT
#undef EC_ASSERT
#endif
// add by FIBOCOM_BASE END
