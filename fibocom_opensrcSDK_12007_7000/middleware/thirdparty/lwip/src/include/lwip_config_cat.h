...
#define TCPIP_MAX_IP_PKG_DUMP_LEN   1500

/*define dump log ETHER packet max size*/
#define TCPIP_MAX_ETH_PKG_DUMP_LEN   1500
#else
...
#ifdef  CONFIG_JIMIWULIAN_FEATURE
...
#ifdef CONFIG_LWIP_USER_SUPPORT
//2025-07-29 Increase the maximum value of UDP socke Jira: MTC0991-999   Qiujianhua
#define MEMP_NUM_UDP_PCB                42
#else
 ...
 */
//2025-10-25, zuojiliang, MTC0991-1061, Start. modify type 7 memory pool.
...
#endif
#endif
//2025-10-25, zuojiliang, MTC0991-1061, End.

/**
 * MEMP_NUM_NETCONN: the number of struct netconns.
 * (only needed if you use the sequential API, like api_lib.c)
 */
//2025-04-08, zuojiliang, MTC0991-565/MTC0756-1658, Start. modify socket max num.
#if !defined MEMP_NUM_NETCONN || defined __DOXYGEN__
#ifdef CONFIG_LWIP_USER_SUPPORT
#define MEMP_NUM_NETCONN                45
#else
#define MEMP_NUM_NETCONN                23
#endif
#endif
//2025-04-08, zuojiliang, MTC0991-565/MTC0756-1658, End.
...
#elif defined CONFIG_LWIP_ZETIAN_CONFIG
...
#define DNS_MAX_SERVERS                 28            //multiple(3) pdn case  //MTC1093-573
#endif
 ...
 */
//2025-04-23 Modify Start, zuojiliang, MTC1007-387,MTC0991-940, Modify the sliding window size.
#if !defined TCP_WND || defined __DOXYGEN__
#ifdef CONFIG_CUST_HUAZHIRONG_FEATURE
#define TCP_WND                         (16 * 1024) //16*TCP_MSS
#elif defined TYPE_EC718M
#define TCP_WND                         (40 * 1024) //40*TCP_MSS
#else
#define TCP_WND                         (6 * 1024) //6*TCP_MSS
#endif
#endif
//2025-04-23 Modify End, zuojiliang.
...
#ifdef CONFIG_LWIP_ZETIAN_CONFIG
 ...
 */
//2025-10-25, zuojiliang, MTC0991-1295, Start. Cancel the loopback restriction.
#if !defined LWIP_LOOPBACK_MAX_PBUFS || defined __DOXYGEN__
#ifdef CONFIG_LWIP_USER_SUPPORT
#define LWIP_LOOPBACK_MAX_PBUFS         0xFFFF
#else
#define LWIP_LOOPBACK_MAX_PBUFS         4
#endif
#endif
//2025-10-25, zuojiliang, MTC0991-1295, End.
...
#ifdef CONFIG_CUST_HUAZHIRONG_FEATURE
#define DEFAULT_UDP_RECVMBOX_SIZE       26
#elif defined TYPE_EC718M
...
#ifdef CONFIG_CUST_HUAZHIRONG_FEATURE
#define DEFAULT_TCP_RECVMBOX_SIZE       45
#elif defined TYPE_EC718M
#define DEFAULT_TCP_RECVMBOX_SIZE       45
#else
