...
//2024-06-29, mahongmei, MTC0708-962, Begin. clip some log for more flash to new function.
#ifdef FIBOCOM_BASE
#define __NULL__FILE__  ""
#endif
...
#define MBEDTLS_SSL_DEBUG_MSG( level, args )                    \
        mbedtls_debug_print_msg( ssl, level, __NULL__FILE__, __LINE__,    \
...
#define MBEDTLS_SSL_DEBUG_RET( level, text, ret )                \
        mbedtls_debug_print_ret( ssl, level, __NULL__FILE__, __LINE__, text, ret )
#else
#define MBEDTLS_SSL_DEBUG_RET( level, text, ret )                \
...
#define MBEDTLS_SSL_DEBUG_BUF( level, text, buf, len )           \
        mbedtls_debug_print_buf( ssl, level, __NULL__FILE__, __LINE__, text, buf, len )
#else
#define MBEDTLS_SSL_DEBUG_BUF( level, text, buf, len )           \
...
#define MBEDTLS_SSL_DEBUG_MPI( level, text, X )                  \
        mbedtls_debug_print_mpi( ssl, level, __NULL__FILE__, __LINE__, text, X )
#else  
#define MBEDTLS_SSL_DEBUG_MPI( level, text, X )                  \
    mbedtls_debug_print_mpi( ssl, level, __FILE__, __LINE__, text, X )
#endif
#endif
//2024-06-29, mahongmei, MTC0708-962, End.
