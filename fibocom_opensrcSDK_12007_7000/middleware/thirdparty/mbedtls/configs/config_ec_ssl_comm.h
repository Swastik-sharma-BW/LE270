...
#if defined(FEATURE_APP_TLS_ENABLE) || defined(FEATURE_MQTT_TLS_ENABLE) || defined(FIBOCOM_BASE)

#ifdef CONFIG_FFW_WXPAY_SPEAKER_JIEKE
#define MBEDTLS_CIPHER_MODE_CFB /// for jieke
#endif

#if defined(FIBOCOM_BASE)
#ifndef CONFIG_FIBOCOM_CLIP_SSL
...
#else 
#if defined(FIBOCOM_BASE)  //add by fibocom
#define MBEDTLS_SSL_MAX_CONTENT_LEN         (16*1024)   /**< Size of the input / output buffer */
#else
...
/*默认打开DTLS功能宏，flash多出10k，后续如果客户需要可以裁剪*/
...
#if defined(CONFIG_FIBOCOM_CLIP_SPACE)&&defined(FIBOCOM_BASE)
 ...
 */
#if defined(CONFIG_FIBOCOM_CLIP_SSL)&&defined(FIBOCOM_BASE)
#else
...
#if defined(CONFIG_FIBOCOM_CLIP_SSL)&&defined(FIBOCOM_BASE)
#else
//2024-09-26 Modify Start, qiaoyu, MTC0729-429, customer requirement.
#define MBEDTLS_SSL_MAX_FRAGMENT_LENGTH
//2024-09-25 Modify End, qiaoyu, MTC0729-429.
#endif
/**
