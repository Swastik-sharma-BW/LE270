...
#define demo_filepath "/fsdemotest1"
#define demo_2filepath "/fsdemotest2"
#define demo_filename "/fsdemotest1" "/testfile.txt"
#define demo_2filename "/fsdemotest2" "/testfile.txt"
#define demo_1filerename "/fsdemotest1" "/renamefile1.txt"
#define demo_2filerename "/fsdemotest1" "/renamefile2.txt"
...
static void ffs_thread_entry(void *param)
{
    ...
    do
    {
        ...
        if (statcmp)
        {
            ret = memcmp(st1, st2, sizeof(fibo_stat));
            if (0 != ret)
            {
...
int appimg_enter(void *param)
{
    ...
    if (0 == fibo_thread_create(ffs_thread_entry, (INT8*)"demo_thread", THREAD_STACK_SIZE, NULL, osPriorityNormal))
    {
