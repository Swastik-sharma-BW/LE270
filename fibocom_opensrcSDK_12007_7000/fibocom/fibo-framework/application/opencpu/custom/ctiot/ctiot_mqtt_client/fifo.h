...
int32_t fifo_init (fifo_ram_t *m_fifo_ram, void *buf, size_t size);
int32_t fifo_get  (fifo_ram_t *m_fifo_ram, void *buf, uint32_t len);
int32_t fifo_copy (fifo_ram_t *m_fifo_ram, void *buf, uint32_t len);
int32_t fifo_put  (fifo_ram_t *m_fifo_ram, void *buf, uint32_t len);
int32_t fifo_flush(fifo_ram_t *m_fifo_ram);
int32_t fifo_delete_topnode(fifo_ram_t *m_fifo_ram);
