...
typedef enum {
    ...
    BOT_MID_COMP_CHAIN       = 0x09, /* CHAIN component. */
    BOT_MID_COMP_TCP         = 0x0a, /* TCP component. */

    BOT_MID_SRV_DTC          = 0x30, /* Service : Data to Cloud/Chain */
    BOT_MID_SRV_NTP          = 0x31, /* Service : NTP */
    BOT_MID_SRV_SUBDEV       = 0x32, /* Service bot : subdev */
    BOT_MID_SRV_CHANNEL      = 0x33, /* Service : CHANNEL */

    BOT_MID_SYS_DEP          = 0x60, /* System Dependencies. */

    BOT_MID_3RD_LINKSDK      = 0x80, /* 3rd : LINK SDK. */
    BOT_MID_MAX
} bot_module_id;
...
#define BOT_EAT_TCP_INIT                    BOT_ERRNO_ERROR(BOT_MID_COMP_AT, 0X0009) /* -0x02000009 */
#define BOT_EAT_MALLOC_FAIL                 BOT_ERRNO_ERROR(BOT_MID_COMP_AT, 0X000A) /* -0x0200000a */
#define BOT_EAT_AT_COMP_NOT_INIT            BOT_ERRNO_ERROR(BOT_MID_COMP_AT, 0X000B) /* -0x0200000b */
#define BOT_EAT_QUEUE_CREATE_FAIL           BOT_ERRNO_ERROR(BOT_MID_COMP_AT, 0X000C) /* -0x0200000c */
#define BOT_EAT_MUTEX_CREATE_FAIL           BOT_ERRNO_ERROR(BOT_MID_COMP_AT, 0X000D) /* -0x0200000d */
#define BOT_EAT_STIMER_CREATE_FAIL          BOT_ERRNO_ERROR(BOT_MID_COMP_AT, 0X000E) /* -0x0200000e */
...
#define BOT_ENET_COAP_INIT_ERR              BOT_ERRNO_ERROR(BOT_MID_COMP_NET, 0X000F) /* -0x0206000F */
/* network module coap connect failed */
#define BOT_ENET_COAP_CONNECT_ERR           BOT_ERRNO_ERROR(BOT_MID_COMP_NET, 0X0010) /* -0x02060010 */
/* network module coap disconnect failed */
#define BOT_ENET_COAP_DISCONNECT_ERR        BOT_ERRNO_ERROR(BOT_MID_COMP_NET, 0X0011) /* -0x02060011 */
/* network module coap send data failed */
#define BOT_ENET_COAP_SEND_DATA_ERR         BOT_ERRNO_ERROR(BOT_MID_COMP_NET, 0X0012) /* -0x02060012 */
/* network module coap request auth token filed */
#define BOT_ENET_COAP_AUTH_TOKEN_ERR        BOT_ERRNO_ERROR(BOT_MID_COMP_NET, 0X0013) /* -0x02060013 */
/* network module mqtt auth failed */
#define BOT_ENET_MQTT_AUTH_ERR              BOT_ERRNO_ERROR(BOT_MID_COMP_NET, 0X0014) /* -0x02060014 */
/* ------------------------------------------------------------------------------ */
...
/* utils dev uid type error */
#define BOT_EUTILS_DEV_UID_TYPE             BOT_ERRNO_ERROR(BOT_MID_COMP_UTILS, 0X0003) /* -0x02080003 */
/* utils dev uid info get fail */
#define BOT_EUTILS_DEV_UID_INFO             BOT_ERRNO_ERROR(BOT_MID_COMP_UTILS, 0X0004) /* -0x02080004 */
/* utils dev network type error */
#define BOT_EUTILS_DEV_NETWORK_TYPE         BOT_ERRNO_ERROR(BOT_MID_COMP_UTILS, 0X0005) /* -0x02080005 */

/* ------------------------------------------------------------------------------ */

/* ------------------------- CHAIN Components Errcode --------------------------- */
/* chain module get ecc curve fail */
#define BOT_ECHAIN_ALG_TYPE_ERR             BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0003) /* -0x02090003 */
/* chain module sign with ecc fail */
#define BOT_ECHAIN_ECC_SIGN_ERR             BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0004) /* -0x02090004 */
/* chain module get random number fail */
#define BOT_ECHAIN_RAND_ERR                 BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0005) /* -0x02090005 */

/* chain module net connect fail */
#define BOT_ECHAIN_NET_CONNECT_ERR          BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0010) /* -0x02090010 */
/* chain module net send fail */
#define BOT_ECHAIN_NET_SEND_ERR             BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0011) /* -0x02090011 */
/* chain module net receive fail */
#define BOT_ECHAIN_NET_RECV_ERR             BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0012) /* -0x02090012 */
/* chain module packet head get fail */
#define BOT_ECHAIN_HEAD_RECV_ERR            BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0013) /* -0x02090013 */
/* chain module packet head verify fail */
#define BOT_ECHAIN_HEAD_VERIFY_ERR          BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0014) /* -0x02090014 */
/* chain module handshake fail */
#define BOT_ECHAIN_HANDSHAKE_ERR            BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0015) /* -0x02090015 */

/* chain module response return error */
#define BOT_ECHAIN_RESP_ERR                 BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0020) /* -0x02090020 */
/* chain module recepit return error */
#define BOT_ECHAIN_RECEPIT_ERR              BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0021) /* -0x02090021 */
/* chain module transaction response parse fail */
#define BOT_ECHAIN_TRANS_RESP_PARSE_ERR     BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0022) /* -0x02090022 */
/* chain module deposit data fail */
#define BOT_ECHAIN_DEPOSIT_DATA_ERR         BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0023) /* -0x02090023 */
/* chain module message not defined */
#define BOT_ECHAIN_NO_DEFINED_MSG           BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0024) /* -0x02090024 */
/* chain module transaction parse fail */
#define BOT_ECHAIN_TRANS_PARSE_ERR          BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0025) /* -0x02090025 */
/* chain module data to be deposited is too long*/
#define BOT_ECHAIN_TRANS_DATA_OVERSIZE      BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0026) /* -0x02090026 */
/* chain module rlp decode fail, too few itms */
#define BOT_ECHAIN_MISSING_ITEMS            BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0027) /* -0x02090027 */
/* chain module response type mimatch */
#define BOT_ECHAIN_RESP_TYPE_MISMATCH       BOT_ERRNO_ERROR(BOT_MID_COMP_CHAIN, 0X0028) /* -0x02090028 */
/* ------------------------------------------------------------------------------ */


/* ------------------------- TCP Components Errcode --------------------------- */
/* tcp server init fail */
#define BOT_ETCP_SERVER_INIT_FAIL           BOT_ERRNO_ERROR(BOT_MID_COMP_TCP,   0X0001) /* -0x020a0001 */
/* tcp server deinit fail */
#define BOT_ETCP_SERVER_DEINIT_FAIL         BOT_ERRNO_ERROR(BOT_MID_COMP_TCP,   0X0002) /* -0x020a0002 */
/* ------------------------------------------------------------------------------ */
...
/* zero config not set */
#define BOT_EDTC_CONFIG_NOT_SET             BOT_ERRNO_ERROR(BOT_MID_SRV_DTC, 0X0219) /* -0x02300219 */
/* net not ready */
#define BOT_EDTC_NET_NOT_READY              BOT_ERRNO_ERROR(BOT_MID_SRV_DTC, 0X021A) /* -0x0230021A */
...
/* The sent length does not match the actual length */
#define BOT_EDTC_LEN_MISMATCH               BOT_ERRNO_ERROR(BOT_MID_SRV_DTC, 0X0506) /* -0x02300506 */
/* ------------------------------------------------------------------------------ */
...
/* ------------------------- SUBDEV Service bot Errcode --------------------------- */
/* subdev service enter error codes */
#define BOT_ESUBDEV_ENTER                   BOT_ERRNO_ERROR(BOT_MID_SRV_SUBDEV, 0X0001) /* -0x02320001 */
/* mqtt handle get timeout */
#define BOT_ESUBDEV_MQTT_HANDLE_TIMEOUT     BOT_ERRNO_ERROR(BOT_MID_SRV_SUBDEV, 0X0002) /* -0x02320002 */
/* subdev mutex null */
#define BOT_ESUBDEV_MUTEX_NULL              BOT_ERRNO_ERROR(BOT_MID_SRV_SUBDEV, 0X0003) /* -0x02320003 */
/* subdev sem null */
#define BOT_ESUBDEV_SEM_NULL                BOT_ERRNO_ERROR(BOT_MID_SRV_SUBDEV, 0X0004) /* -0x02320004 */
/* subdev dev info null */
#define BOT_ESUBDEV_DEV_INFO_NULL           BOT_ERRNO_ERROR(BOT_MID_SRV_SUBDEV, 0X0005) /* -0x02320005 */
/* subdev malloc error */
#define BOT_ESUBDEV_MALLOC_NULL             BOT_ERRNO_ERROR(BOT_MID_SRV_SUBDEV, 0X0006) /* -0x02320006 */
/* subdev asset reg ack quantity error */
#define BOT_ESUBDEV_ASSET_ACK_ERROR         BOT_ERRNO_ERROR(BOT_MID_SRV_SUBDEV, 0X0007) /* -0x02320007 */
/* subdev dev send data info error */
#define BOT_ESUBDEV_PAYLOAD_INFO_ERROR      BOT_ERRNO_ERROR(BOT_MID_SRV_SUBDEV, 0X0008) /* -0x02320008 */
/* subdev node inexistence */
#define BOT_ESUBDEV_NODE_INEXISTENCE        BOT_ERRNO_ERROR(BOT_MID_SRV_SUBDEV, 0X0009) /* -0x02320009 */
/* subdev node inexistence */
#define BOT_ESUBDEV_ASSETREG_ID_ERROR       BOT_ERRNO_ERROR(BOT_MID_SRV_SUBDEV, 0X000A) /* -0x0232000A */
/* ------------------------------------------------------------------------------ */

/* ------------------------- CHANNEL Service bot Errcode --------------------------- */
/* channel service post init error */
#define BOT_ECHANNEL_POST                   BOT_ERRNO_ERROR(BOT_MID_SRV_CHANNEL, 0X0001) /* -0x02330001 */
/* channel service aiot connect error */
#define BOT_ECHANNEL_IOT                    BOT_ERRNO_ERROR(BOT_MID_SRV_CHANNEL, 0X0002) /* -0x02330002 */
/* channel service devinfo report error */
#define BOT_ECHANNEL_DEVINFO_REPORT         BOT_ERRNO_ERROR(BOT_MID_SRV_CHANNEL, 0X0003) /* -0x02330003 */
/* channel service ntp init error */
#define BOT_ECHANNEL_NTP                    BOT_ERRNO_ERROR(BOT_MID_SRV_CHANNEL, 0X0004) /* -0x02330004 */
/* channel service timer init error */
#define BOT_ECHANNEL_TIMER                  BOT_ERRNO_ERROR(BOT_MID_SRV_CHANNEL, 0X0005) /* -0x02330005 */


/* ------------------------- System Dependencies bot Errcode --------------------------- */
/* platform init fail */
#define BOT_EPALTFORM_INIT                  BOT_ERRNO_ERROR(BOT_MID_SYS_DEP, 0X0001)    /* -0x02360001 */
/* device info get fail */
#define BOT_EDEVINFO_GET                    BOT_ERRNO_ERROR(BOT_MID_SYS_DEP, 0X0002)    /* -0x02360002 */
/* sem operation  fail */
#define BOT_EADP_SEM                        BOT_ERRNO_ERROR(BOT_MID_SYS_DEP, 0X0003)    /* -0x02360003 */
/* task operation  fail */
#define BOT_EADP_TASK                       BOT_ERRNO_ERROR(BOT_MID_SYS_DEP, 0X0004)    /* -0x02360004 */
/* queue operation  fail */
#define BOT_EADP_QUEUE                      BOT_ERRNO_ERROR(BOT_MID_SYS_DEP, 0X0005)    /* -0x02360005 */
/* mutex operation  fail */
#define BOT_EADP_MUTEX                      BOT_ERRNO_ERROR(BOT_MID_SYS_DEP, 0X0006)    /* -0x02360006 */


/* ------------------------- 3rd LinkSDK --------------------------- */
#define BOT_ELINKSDK(err)                   BOT_ERRNO_ERROR(BOT_MID_3RD_LINKSDK, -(err))    /* -0x0280**** */
