 ...
 * @brief bot flash component header file
...
/** @enum bot_partition_id_e
    @brief Flash partition id defines
*/
typedef enum {
...
/** @struct bot_hal_logic_partition_t
    @brief Description of the flash partition
*/
typedef struct {
...
/**
 * @brief get flash area information
 *
 ...
 *
 * @return get hal flash info result
 * @retval 0 success
 * @retval others fail
 */
...
/**
 * @brief This function will initialize flash
 *
 * @return flash init result
 * @retval 0 success
 * @retval others fail
 */
