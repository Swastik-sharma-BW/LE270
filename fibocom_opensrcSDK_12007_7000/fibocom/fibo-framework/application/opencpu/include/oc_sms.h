...
#define FIBO_SMS_MESSAGE_LENGTH_MAX 380
...
typedef struct
{
    e_fibo_sms_storage_type_t storage_type;//Invalid parameter
    uint8_t tag_type_valid;//Invalid parameter
    e_fibo_sms_tag_type_t tag_type;//Invalid parameter
    uint8_t message_mode_valid;//Invalid parameter
    e_fibo_sms_mode_type_t message_mode;//Invalid parameter
...
{
    e_fibo_sms_storage_type_t e_storage;
    uint8_t e_mode_valid;//Invalid parameter
    e_fibo_sms_mode_type_t    e_mode;//Invalid parameter
} fibo_sms_get_store_max_size_info_t;

typedef struct
{
    uint32_t store_max_size; //Maximum storage 
    uint8_t store_used_size;
    uint32_t free_slots;//Invalid parameter
