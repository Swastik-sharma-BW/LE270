...
extern INT32 fibo_sock_ntp(char *addr, int port, int nSimID, key_callback cb);
...
extern INT32 fibo_getHostByName(char *hostname, ip_addr_t *addr, uint8_t nCid, int nSimID);
