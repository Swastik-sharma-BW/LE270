...
extern INT32 fibo_http_destory(oc_http_param_t *pstHttpParam, uint8_t *pUserDefHeader);
...
extern INT32 fibo_http_get_sync(const char *url, oc_http_header_t *headers, int header_num, int timeout, oc_htpp_data_callback_t data_callback, void *arg);
#endif // OC_HTTP_H_
