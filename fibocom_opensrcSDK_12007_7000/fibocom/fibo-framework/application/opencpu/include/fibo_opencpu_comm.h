...
#define OSI_PRIORITY_NORMAL osPriorityNormal
#define OSI_PRIORITY_BELOW_NORMAL (osPriorityBelowNormal)
#define OSI_PRIORITY_ABOVE_NORMAL (osPriorityAboveNormal)
#define OSI_PRINTFI fibo_printf
...
typedef enum
{
    ...
    GAPP_SIG_SIM_STATUS_REPORT,
    GAPP_SIG_NW_SIGNAL_QUALITY_IND,
    GAPP_SIG_URC_WAKEUP_HOST_EVENT,
    GAPP_SIG_AT_CONTROL_ENTER_UPDATE_IND,
    GAPP_SIG_NITZ_TIME_SYNC,
    GAPP_SIG_BLE_SCAN_STOP,
    GAPP_SIG_BLE_GATT_SERVICE,
    GAPP_SIG_BLE_GATT_CHAR,
    GAPP_SIG_BLE_MTU_CHANGE,
    GAPP_SIG_BLE_GATT_RECV,
    GAPP_SIG_BLE_READ_GATT_RESP,
    GAPP_SIG_BLE_ADV_OFF,
    GAPP_SIG_MAX,
} GAPP_SIGNAL_ID_T;
