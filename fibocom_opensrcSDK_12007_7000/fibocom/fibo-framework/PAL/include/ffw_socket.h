...
#if defined(FFW_HUAXIAO_CONFIG)
#define FFW_AF_INET6_PRI 100
#endif

#define FFW_SOL_SOCKET 0xFF  /// SOL SOCKET
#define FFW_IPPROTO_TCP 6 /// PROTO TCP
#define FFW_IPPROTO_UDP 17 /// UDP
#define FFW_SOCK_RAW 3  /// RAW SOCKET
#define FFW_IPPROTO_ICMP 1
#define FFW_IPPROTO_ICMPV6 58
#define FFW_IPPROTO_IP 0


#define FFW_SO_ERROR 0            /// SOCKET ERROR
#define FFW_SO_REUSEADDR 1        /// reuse address
#define FFW_TCP_KEEPIDLE 2        /// keepidle
#define FFW_TCP_KEEPINTVL 3       /// keepintvl
#define FFW_TCP_KEEPCNT 4         /// keep count
#define FFW_TCP_RETR_NUM 5        /// retry num
#define FFW_TCP_MIN_RTO 6         /// min rto
#define FFW_TCP_MAX_RTO 7         /// max rto
#define FFW_TCP_MAX_CLOSE_DELAY 8 /// close delay
#define FFW_TCP_NODELAY 9         /// no delay
#define FFW_SO_KEEPALIVE 10       /// keepalive
#define FFW_IP_TOS 11
#define FFW_IP_TTL 12
//2024-10-22 Modify Start, sundaqing, MTC0709-965
#define FFW_TCP_INFO 13
//2024-10-22 Modify End, sundaqing, MTC0709-965
#define FFW_SO_REUSEPORT 14        /// reuse port

#define FFW_SOCK_STREAM 1 /// for tcp
#define FFW_SOCK_DGRAM 2 /// for udp




/// socket errno
#define FFW_ECONNREFUSED 111 /// refused
#define FFW_ETIMEDOUT 110    /// timeout
#define FFW_EWOULDBLOCK 11  /// read/write again
#define FFW_EINPROGRESS 115 /// progress
...
/// sendto api
int ffw_sendto(int fd, const void *data, uint32_t size, int flags, const struct ffw_sockaddr *to, int tolen);

/// recv api
int ffw_recv(int fd, void *data, uint32_t size, int flags);

/// recvfrom api
int ffw_recvfrom(int fd, void *data, uint32_t size, int flags, struct ffw_sockaddr *src_addr, int *addrlen);

/// accept api
int ffw_accept(int fd, struct ffw_sockaddr *addr, int *addrlen);

/// bind api
int ffw_bind(int fd, struct ffw_sockaddr *pname, int namelen);
...
/// 创建fdset，释放可以使用ffw_put_memory
ffw_fd_set ffw_fd_set_create();

/// select
int ffw_select(int nfds, ffw_fd_set readfds, ffw_fd_set writefds, ffw_fd_set exceptfds, struct ffw_timeval *timeout);
 ...
 * @return int32_t 
 */
int32_t ffw_socket_getsockname(int sockfd, struct ffw_sockaddr *laddr);
 ...
 * @return int32_t 
 */
int32_t ffw_socket_getpeername(int sockfd, struct ffw_sockaddr *laddr);
...
* @return int 
 */
int ffw_sock_recv_available(int fd, int32_t *size);
...
* @return int
*/
int ffw_get_NetInfo_platf(uint32_t *pNetInfo, uint8_t DataSize);
