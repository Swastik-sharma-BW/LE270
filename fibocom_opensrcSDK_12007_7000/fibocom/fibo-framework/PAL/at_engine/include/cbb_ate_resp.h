 ...
 */
#ifdef __LINUX__
int32_t cbb_ate_send_urc_data_fmt(ffw_handle_t e, const char *fmt, ...) __attribute__((format(printf, 2, 3)));
#else
int32_t cbb_ate_send_urc_data_fmt(ffw_handle_t e, const char *fmt, ...);
#endif
...
#ifdef __LINUX__
int32_t cbb_ate_info_data_fmt(ffw_handle_t e, const char *fmt, ...) __attribute__((format(printf, 2, 3)));
#else
int32_t cbb_ate_info_data_fmt(ffw_handle_t e, const char *fmt, ...);
#endif


/**
* @brief 格式化的方式发送任意格式的错误信息
* 
* @param engine 
* @param fmt 
* @param ... 
...
#ifdef __LINUX__
int32_t cbb_ate_result_data_fmt(ffw_handle_t engine, const char *fmt, ...) __attribute__((format(printf, 2, 3)));;
#else
