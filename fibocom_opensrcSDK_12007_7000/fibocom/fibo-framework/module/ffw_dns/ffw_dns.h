...
* @param type FFW_AF_INET 或者 FFW_AF_INET6
* @param port 端口
* @param timeout 超时时间，单位为毫秒
...
* @retval FFW_R_FAILED: 失败 
 */
int ffw_getaddrinfo1(const char *hostname, int family, uint16_t port, int timeout, struct ffw_addrinfo **addrinfo, const char **dnsserver, int servercnt, ffw_handle_t netif);
