...
/* before */
//#define FFW_SSL_CA_DIRNAME FFW_BASE_DIRNAME FFW_FS_SEP "ca"
//#define FFW_SSL_KEY_DIRNAME FFW_BASE_DIRNAME FFW_FS_SEP "key"
/* after */ //Save Flash Space
#define FFW_SSL_CA_DIRNAME FFW_BASE_DIRNAME
#define FFW_SSL_KEY_DIRNAME FFW_BASE_DIRNAME
...
* 
* @param h 句柄
* @param family FFW_AF_INET 或者 FFW_AF_INET6 
* @param lport 源端口
* @param host 对端地址
* @param port 对端端口号
* @param timeout 超时时间，单位毫秒
