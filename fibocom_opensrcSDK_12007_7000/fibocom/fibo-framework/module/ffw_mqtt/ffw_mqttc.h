...
struct ffw_mqttc_s
{
    ...
    struct list_head unacked_msg_queue;
...
* @retval FFW_R_FAILED: 失败 
 */
int ffw_mqttc_connect(ffw_mqttc_t *c, const char *client_id, const char *host, uint16_t port, bool clearsession, uint32_t keepalive, bool tls, int32_t timeout);
...
* @retval FFW_R_FAILED: 失败 
 */
int ffw_mqttc_connect1(ffw_mqttc_t *c, const char *client_id, const char *host, uint16_t port, bool clearsession, uint32_t keepalive, bool tls, int32_t timeout);
...
* @retval FFW_R_FAILED: 失败  
 */
int ffw_mqttc_sub(ffw_mqttc_t *c, const char *topic, int qos, uint16_t *pacid);
...
* @retval FFW_R_FAILED: 失败  
 */
int ffw_mqttc_sub_multi_topic(ffw_mqttc_t *c, const char **topics, int *qos, int topic_num, uint16_t *pacid);
...
* @retval FFW_R_FAILED: 失败  
 */
int ffw_mqttc_unsub(ffw_mqttc_t *client, const char *topic, uint16_t *pacid);
...
* @retval FFW_R_FAILED: 失败 
 */
int ffw_mqttc_pub(ffw_mqttc_t *client, const char *topic, int qos, bool retain, bool dup, const uint8_t *payload, uint16_t payload_len, uint16_t *pacid);
...
* @retval FFW_R_FAILED: 失败 
 */
int ffw_mqttc_pub_header(ffw_mqttc_t *c, const char *topic, int qos, bool retain, bool dup, uint16_t payload_len, uint16_t *pacid);
...
* @retval FFW_R_FAILED: 失败 
 */
int ffw_mqttc_pub_data(ffw_mqttc_t *c, const uint8_t *data, uint16_t data_len);
...
* 
 */
bool ffw_mqttc_is_idle(ffw_mqttc_t *c);
...
int ffw_mqttc_retry_interval(ffw_mqttc_t *client, int retrycnt, int interval);
