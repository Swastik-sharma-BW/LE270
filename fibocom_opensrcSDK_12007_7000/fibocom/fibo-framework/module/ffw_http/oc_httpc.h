...
int fibo_http_post_data1(const char *url, const void *buf, uint32_t len, fibo_http_header_t *headers, int header_count, void **res_buf, uint32_t *res_len, int32_t timeout, int *res_code);
