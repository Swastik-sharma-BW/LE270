...
/**
* @brief malloc on psram
* 
* @param b 
* @param size 
* @return int 
 */
int ffw_buffer_create1(ffw_buffer_t *b, uint32_t size);
...
* @return int 
 */
int ffw_buffer_destory1(ffw_buffer_t *b);
...
int ffw_buffer_append1(ffw_buffer_t *b, const void *data, uint32_t len);
