...
// UART3 (Universal asynchronous receiver transmitter) [Driver_USART3]
// Configuration settings for Driver_USART3 in component ::Drivers:USART
//2024-06-19, wangzhen, MTC0818-23. EC716x platform does not support UART3
#if defined (FIBOCOM_BASE) && !defined (CHIP_EC716)
#define RTE_UART3                       1

// { PAD_PIN40},  // 0 : gpio34  / 3 : UART3 RXD
// { PAD_PIN41},  // 0 : gpio35  / 3 : UART3 TXD
...
//2024-06-19, wangzhen, MTC0818-23. EC716x platform does not support SPI1
#if defined (FIBOCOM_BASE) && !defined (CHIP_EC716)
#define RTE_SPI1                        1
#else
#define RTE_SPI1                        0
...
#ifdef CONFIG_FFW_USB_EXINTF_ENABLE
...
#ifndef FIBOCOM_OPENCPU     //Modify by liuben for CMUX
...
#undef  RTE_SPI_EN
#undef  RTE_TWO_UART_AT
#undef  RTE_OPAQ_EN
#define RTE_SPI_EN                      1
#define RTE_TWO_UART_AT                 1
#define RTE_EOS_EN                      0
#define RTE_IPOS_EN                     1
#define RTE_OPAQ_EN                     1
#endif
...
#ifdef CONFIG_ECM_DATACALL_ENABLE
#ifdef RTE_ETHER_EN
#undef RTE_ETHER_EN
#define RTE_ETHER_EN                    1
#endif
#define RTE_ETH_LAN_EN                  RTE_ETHER_EN
#endif
...
#ifdef FIBOCOM_BASE
#define VOLTE_EC_OWN_BOARD_SUPPORT      0
#else
...
#ifdef FIBOCOM_BASE
#if defined CHIP_EC718
#define UART1_DTR_PAD_INDEX             47     // GPIO22
#define UART1_DTR_GPIO_INSTANCE         1
#define UART1_DTR_GPIO_PIN              6
...
#define UART1_DCD_PAD_INDEX             12     // SWDIO0 = GPIO17
#define UART1_DCD_GPIO_INSTANCE         1
#define UART1_DCD_GPIO_PIN              1

#elif defined CHIP_EC716
#define UART1_DTR_PAD_INDEX             24     // GPIO12
#define UART1_DTR_GPIO_INSTANCE         0
#define UART1_DTR_GPIO_PIN              12
...
#define UART1_DCD_PAD_INDEX             9     // SWDIO0 = GPIO18
#define UART1_DCD_GPIO_INSTANCE         1
#define UART1_DCD_GPIO_PIN              2
#endif
...
#elif defined CHIP_EC716
#define USIM1_URST_OP2_PAD_INDEX             13     // GPIO1
#define USIM1_URST_OP2_GPIO_INSTANCE         0
#define USIM1_URST_OP2_GPIO_PIN              1
#define USIM1_UCLK_OP2_PAD_INDEX             14     // GPIO2
#define USIM1_UCLK_OP2_GPIO_INSTANCE         0
#define USIM1_UCLK_OP2_GPIO_PIN              2
#define USIM1_UIO_OP2_PAD_INDEX              15     // GPIO3
#define USIM1_UIO_OP2_GPIO_INSTANCE          0
#define USIM1_UIO_OP2_GPIO_PIN               3
#endif

#ifdef FIBOCOM_BASE
//USIM1 clock latched by AONIO, for example, use AONIO-8 test on EVB
#if defined CHIP_EC718
#define USIM1_LATCH_IO_PAD_INDEX        53     // AONIO 8 = GPIO28
#define USIM1_LATCH_IO_INSTANCE         1
#define USIM1_LATCH_IO_PIN              12
#elif defined CHIP_EC716
#define USIM1_LATCH_IO_PAD_INDEX        28     // AONIO 6 = GPIO16
#define USIM1_LATCH_IO_INSTANCE         1
#define USIM1_LATCH_IO_PIN              0 //GPIO16, (16 % 16)
#endif
#else
