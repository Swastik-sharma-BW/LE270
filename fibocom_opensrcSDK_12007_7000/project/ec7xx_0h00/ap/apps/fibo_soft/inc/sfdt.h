...
#if defined CHIP_EC718
#ifdef FIBOCOM_BASE
#define SFDT_SLAVE_SRDY_PAD_INDEX        12      // PIN21 ((GPIO17))
#define SFDT_SLAVE_SRDY_PAD_ALT_FUNC     PAD_MUX_ALT4
#define SFDT_SLAVE_SRDY_GPIO_INSTANCE    1       // PIN21 ((GPIO17))
#define SFDT_SLAVE_SRDY_GPIO_INDEX       1       // PIN21 ((GPIO17))
#else
...
#elif defined CHIP_EC716
#ifdef FIBOCOM_BASE
#define SFDT_SLAVE_SRDY_PAD_INDEX        9      // PIN21 GPIO18
#define SFDT_SLAVE_SRDY_PAD_ALT_FUNC     PAD_MUX_ALT4
#define SFDT_SLAVE_SRDY_GPIO_INSTANCE    1       // PIN21 GPIO18
#define SFDT_SLAVE_SRDY_GPIO_INDEX       2      // PIN21 GPIO18
#else
