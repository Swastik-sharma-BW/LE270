...
__USED static uint8_t rsvUsrRam[1*1024];    // 174KB ram reserved for customer
...
__attribute__((weak)) void Pad3_WakeupIntHook(void) {}
...
__attribute__((weak)) void Pad4_WakeupIntHook(void) {}
